...
INSERT INTO `columns` VALUES (1,1,'Column #1'),(2,1,'Column #2'),(3,1,'Column #3'),(4,2,'Column #4'),(5,2,'Column #5'),(6,2,'Column #6');
...
INSERT INTO `projects` VALUES (1,1,'1333302165','RosaSync',''),(2,1,'1336900727','Project 2','Project 2');
...
CREATE TABLE `projects_access` (
  `uid` int(11) NOT NULL,
  `mode` longtext COLLATE utf8_unicode_ci NOT NULL,
  KEY `uid` (`uid`)
...
LOCK TABLES `projects_access` WRITE;
/*!40000 ALTER TABLE `projects_access` DISABLE KEYS */;
INSERT INTO `projects_access` VALUES (2,'a:1:{i:1;s:1:\"7\";}'),(1,'a:2:{i:1;s:1:\"7\";i:2;s:1:\"7\";}');
/*!40000 ALTER TABLE `projects_access` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `projects_columns` VALUES (1,1),(2,1),(3,1),(4,2),(5,2),(6,2);
...
INSERT INTO `users` VALUES (0,'','',NULL,0,0,0,0,''),(1,'admin','cfafe6d0c990756730306d128df214d4','shi3a@yandex.ru',1334687069,1334687069,1334687069,1,'microsoft'),(2,'user','3321ecdb14cccb743f38cbaa60cc31ef','shi3a@rambler.ru',1336905029,1336905029,1336905029,1,'user');
...
-- Dump completed on 2012-05-15  9:05:08
